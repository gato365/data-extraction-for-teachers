...
| Feature | **Geocoding API** | **Current Weather API (v2.5)** | **One Call API (v3.0)** |
|----------------|----------------|------------------|----------------------|
...
| **Use case** | Finding lat/lon of cities | Lightweight current conditions | Complete weather view (e.g., dashboards/apps) |
