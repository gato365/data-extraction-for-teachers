...
show images creating an app (provide my youtube video)
  - going to website
  - filling in information for api
  - click on what approtate location
...
Note 11:
How databases and access can change.
Data types are usually sotred correctly as chars or numerics so noy much cleaning required
